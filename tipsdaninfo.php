...
?>
  <a href="tipsdaninfo.php?id_konten=<?php echo $data['id_konten'] ?>" class="list-group-item"><?php echo $data['judul_konten'] ;?></a>
<?php } } ?>
</div>
</div>
...
<?php
    //query ke database dg SELECT table siswa diurutkan berdasarkan NIS paling besar
    $query = mysqli_query($con, "SELECT * FROM tbl_konten where id_konten='$_GET[id_konten]'") or die(mysql_error());
...
<div class="row">
  <div class="col-md-12">
    <input readonly="" type="text" class="form-control" placeholder="Nama Anda" name="nama_komentar">
  </div>
</div>
<br>
...
<center>
 <button name="tambah" type="button" class="btn btn-default" onclick="alert('Maaf, anda harus daftar terlebih dahulu untuk memberi komentar')">Tambahkan Komentar</button>
 <button name="tambah" type="submit" class="btn btn-default">Daftar</button>
 </center>
 </div>
 </form>     
</div>
